      ...
      <main className="flex-1 px-4 pb-6 space-y-4 pt-3">
        ...
        >
          <div className="w-11 h-11 rounded-full bg-blue-50 flex items-center justify-center flex-shrink-0">
            <svg className="w-6 h-6 text-[#1B3A5C]" fill="none" viewBox="0 0 24 24"
              stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round"
          ...
          <div className="text-left flex-1">
            <div className="text-sm font-semibold text-gray-900">Browse Dictionary</div>
            <div className="text-xs text-gray-500 mt-0.5">Search all {(15174).toLocaleString()}+ Dinka words</div>
          </div>
